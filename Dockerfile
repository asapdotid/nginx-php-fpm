...
ADD config/nginx/nginx-site.conf /etc/nginx/sites-available/default.conf
ADD config/nginx/nginx-site-ssl.conf /etc/nginx/sites-available/default-ssl.conf
